  ...
  return (
    <div className="w-11/12 mx-auto text-white p-5">
        <div className="mt-20">
            ...
            <p className="mt-5 tracking-wide text-lg break-words text-gray-400">The animedoro technique, invented by Josh Chen is a modified version of the Pomodoro
        ...
        <div className="mt-20">
            ...
            <p className="mt-5 tracking-wide text-gray-400 text-lg break-words">Animedoro Timer is a modified clone project from 
        ...
        <div className="mt-20">
            ...
            <ol className="mt-5 tracking-wide text-gray-400 text-md break-words"> 
